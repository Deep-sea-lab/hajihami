// Vercel API endpoint for /api/song (Meting API compatible)
...
export default async function handler(req, res) {
  ...
  try {
    // 从查询参数获取ID
    const { id, ids, type = 'hajihami' } = req.query;
    ...
    const idParam = id || ids;
    const idList = Array.isArray(idParam) ? idParam : idParam.toString().split(',');
